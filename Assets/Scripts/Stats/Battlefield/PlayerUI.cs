...
public class PlayerUI : MonoBehaviour
{
    ...
    public void SetButtonsInteractableBasedOnMana(int currentMana, int requiredMana)
    {
        if (attackButton != null) attackButton.interactable = currentMana >= requiredMana;
        if (defenseButton != null) defenseButton.interactable = currentMana >= requiredMana;
        if (manaButton != null) manaButton.interactable = true;  
        if (healButton != null) healButton.interactable = currentMana >= requiredMana;
    }
}