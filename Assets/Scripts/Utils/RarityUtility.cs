...
public static class RarityUtility {
    ...
    {
        { Rarity.Common, new RarityLevel(Rarity.Common, "Common", 0f, 0.5f, Color.gray) },
        { Rarity.Uncommon, new RarityLevel(Rarity.Uncommon, "Uncommon", 0.25f, 0.3f, Color.green) },
        { Rarity.Rare, new RarityLevel(Rarity.Rare, "Rare", 0.5f, 0.15f, Color.blue) },
        { Rarity.Epic, new RarityLevel(Rarity.Epic, "Epic", 0.75f, 0.04f, new Color(0.58f, 0, 0.83f)) },
        { Rarity.Legendary, new RarityLevel(Rarity.Legendary, "Legendary", 1f, 0.01f, new Color(1f, 0.5f, 0f)) }
    };
